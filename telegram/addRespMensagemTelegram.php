...
$queryMsg = " SELECT p.ID AS id, cnt.id AS contato_id, p.post_content as recebida, cnt.nome, 
                cnt.celular, grp.id as grupo_id, grp.grupo, p.post_date AS dt_cadastro
...
<section class="content-header">
  <h1>Telegram Mensagem Recebida</h1>
</section>
		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header">          
					<form name="form" id="form" action="<?php bloginfo('template_url'); ?>/telegram/actions.php?tp=responder" method="post" >
						...
						<div class="col-md-12">&nbsp;</div>
						<div class="col-md-12">
							<a href="<?php bloginfo('template_url'); ?>/controller.php?ctr=telegram&mt=msgRecebida" class="btn btn-default">Voltar</a>&nbsp;
