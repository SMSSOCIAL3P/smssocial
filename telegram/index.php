...
$query = "SELECT p.ID as id,  p.post_content as mensagem, 
          ...
          WHERE cont.id = cmsg.contato_id
            ...
            AND (p.post_type IN ('telegram_msg_enviada','telegram_resp_msg_id'))
            AND (meta.meta_key = 'conf_telegram_id')
            AND cont.flg_atv = 1 AND grp.flg_atv = 1
            AND cont.id_telegram IS NOT NULL
...
<section class="content-header">
  <h1>Telegram Mensagens Enviadas</h1>
</section>
...
<section class="content">
  <div class="row">
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          ...
          <form name="form" id="form" action="<?php home_url(); ?>?ctr=telegram&mt=index" method="post" >
            <div class="col-md-4">
            ...
            <div class="col-md-8" >
              ...
              <a href="<?php bloginfo('template_url'); ?>/controller.php?ctr=telegram&mt=addMsg" class="btn btn-primary" >+ Mensagem</a>
            </div>
          </form>
          ...
          <table id="tabela" class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              foreach($rs as $men) {
                ...
                if($men->agendado != "0000-00-00 00:00:00" && $men->post_type == "tel_msg_enviada") {
                  //mensagens agendadas
                  $ag = true;
              ...
              ?>   
                <tr <?php echo $css; ?> >
                  ...
                  <td>
                    <a href="<?php bloginfo('template_url'); ?>/controller.php?ctr=telegram&mt=addMsg&id=<?php echo $men->id; ?>" title="Editar"> Editar </a> 
                  </td>
                </tr>
              <?php
              } //foreach
    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">          
          <form name="formExportar" id="formExportar" action="<?php bloginfo('template_url'); ?>/telegram/actions.php?tp=exportar" method="post" >
            <div class="col-md-4">
